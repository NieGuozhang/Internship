...
public class NewMyResumeActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 毕业时间的获取，弹出一个时间选择框
		graduatetime.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Calendar c = Calendar.getInstance();// 获取系统日期
				new DatePickerDialog(MyApplicationUtil.getContext(),
						new OnDateSetListener() {
							...
							public void onDateSet(DatePicker view, int year,
								...
								String monthStr = temp < 10 ? "0" + temp : ""
										+ temp;
								graduatetime.setText(year + "-" + monthStr
										+ "-" + dayOfMonth);
							}
