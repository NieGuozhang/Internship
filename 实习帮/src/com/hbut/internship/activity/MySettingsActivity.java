...
public class MySettingsActivity extends BaseActivity {
	...
	private Button modifypasswordButton, feedbackButton, exitloginButton,
			about;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 初始化这些按钮
		back = (ImageButton) findViewById(R.id.imbt_mysettings_back);
		modifypasswordButton = (Button) findViewById(R.id.bt_modifypassword);
		feedbackButton = (Button) findViewById(R.id.bt_feedback);
		exitloginButton = (Button) findViewById(R.id.bt_exitlogin);
		...
		// 退出按钮的点击事件
		exitloginButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
